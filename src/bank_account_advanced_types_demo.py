from bank_account_advanced_types import SavingsAccount, PremiumAccount, InvestmentAccount, AccountFrozenError, InvalidOperationError, InsufficientFundsError, AccountFrozenError, AccountClosedError, InvalidOperationError
...
# Продадим 2 акции АА и получим +20 к балансу
investor.withdraw("stocks", 2, "AA")
